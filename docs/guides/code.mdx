...
<AccordionGroup>
  ...
  <Accordion title="Other Common Issues">
    ...
    - **Import errors**: Install with `uv pip install -e ".[dev]"`
    ...
    - **Pylint not found**: Ensure pylint is installed (`uv pip install pylint`)
    - **Black not found**: Ensure black is installed (`uv pip install black`)
  </Accordion>
</AccordionGroup>
