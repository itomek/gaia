...
<CardGroup cols={3}>
  ...
  <Card title="macOS" icon="apple">
    CLI support via source installation - [See Dev Guide](/reference/dev)
  </Card>
</CardGroup>
...
```bash
# Install MCP support (Linux/Windows)
pip install -e .[mcp]
