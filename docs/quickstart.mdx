...
<Tabs>
  ...
  <Tab title="Developer (Windows)">
    ...
    Create a separate directory for your agent projects (outside the GAIA repo):

    ```powershell
    cd ..; mkdir my-gaia-project; cd my-gaia-project
    ```

    <Tip>
      The GAIA development install is available system-wide in your virtual environment, so you can create agent projects anywhere.
    </Tip>
