# GAIA Routing Agent Documentation
...
- [Code Agent Documentation](./code.md) - Autonomous Python/TypeScript development
- [CLI Guide](./cli.md) - Command line interface reference
- [API Server Documentation](./api.md) - OpenAI-compatible API with routing
