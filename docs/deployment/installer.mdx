...
<Info>
  **Source Code:** [`installer/`](https://github.com/amd/gaia/blob/main/installer/)
</Info>

<Badge text="development" color="orange" />

**Note:** This installer is for Windows only. For Linux systems, see the [Linux Installation Guide](/quickstart) for source-based installation.
...
[MIT License](https://github.com/amd/gaia/blob/main/LICENSE)
